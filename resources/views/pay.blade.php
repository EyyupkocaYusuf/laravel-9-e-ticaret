...
@section('content')
    <div class="container">
        <div class="bg-content">
            <h2>Ödeme</h2>
            <form action="{{ route('pay.topay') }}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_surname" id="adsoyad" value="{{ auth()->user()->name_surname }}" required>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="adres">Adres</label>
                                    <input type="text" class="form-control" name="address" id="address" value="{{ $user_details->address }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telefon" name="phone" id="telefon" value="{{ $user_details->phone }}">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="ceptelefonu">Cep Telefonu</label>
                                    <input type="text" class="form-control telefon" name="mobile_phone" id="ceptelefonu" value="{{ $user_details->mobile_phone }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
